...
Examples:
  ...
  python cli.py infer   --checkpoint output/exp1/checkpoint-epoch-1 --text "Hello world"
    ...
    p_tokenize.add_argument("--model_source", type=str, choices=["HuggingFace"], default="HuggingFace")
    ...
    p_embed.add_argument("--model_source", type=str, choices=["HuggingFace"], default="HuggingFace", help="Model download source")
